...
urlpatterns = [
    ...
    path('reset_password/',auth_views.PasswordResetView.as_view(template_name = 'login_register/reset_password.html',email_template_name='login_register/password_reset_email.html',success_url='/users/login'), name = 'reset'),
